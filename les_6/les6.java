...
public class les6 {
    public static void main(String[] args) {
        Notebook notebook1 = new Notebook("SANSUNK", "8", "1000", "Windows", "grey");
        Notebook notebook2 = new Notebook("APL", "16", "1000", "UBUNTU", "black");
        Notebook notebook3 = new Notebook("ASYSE", "32", "2000", "KUBUNTU", "black");
        Notebook notebook4 = new Notebook("KSIOMI", "64", "1000", "LUBUNTU", "grey");
        Notebook notebook5 = new Notebook("XYAVEY", "4", "1000", "XUBUNTU", "black");
